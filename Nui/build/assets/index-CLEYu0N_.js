 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(z,_){var B=z.length;z.push(_);e:for(;0<B;){var F=B-1>>>1,A=z[F];if(0<o(A,_))z[F]=_,z[B]=A,B=F;else break e}}function r(z){return z.length===0?null:z[0]}function n(z){if(z.length===0)return null;var _=z[0],B=z.pop();if(B!==_){z[0]=B;e:for(var F=0,A=z.length,Ut=A>>>1;F<Ut;){var Ve=2*(F+1)-1,vt=z[Ve],Pe=Ve+1,it=z[Pe];if(0>o(vt,B))Pe<A&&0>o(it,vt)?(z[F]=it,z[Pe]=B,F=Pe):(z[F]=vt,z[Ve]=B,F=Ve);else if(Pe<A&&0>o(it,B))z[F]=it,z[Pe]=B,F=Pe;else break e}}return _}function o(z,_){var B=z.sortIndex-_.sortIndex;return B!==0?B:z.id-_.id}if(typeof performance=="object"&&typeof performance.now=="function"){var l=performance;e.unstable_now=function(){return l.now()}}else{var i=Date,s=i.now();e.unstable_now=function(){return i.now()-s}}var u=[],p=[],v=1,h=null,y=3,g=!1,w=!1,S=!1,b=typeof setTimeout=="function"?setTimeout:null,d=typeof clearTimeout=="function"?clearTimeout:null,c=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function f(z){for(var _=r(p);_!==null;){if(_.callback===null)n(p);else if(_.startTime<=z)n(p),_.sortIndex=_.expirationTime,t(u,_);else break;_=r(p)}}function x(z){if(S=!1,f(z),!w)if(r(u)!==null)w=!0,Jr(k);else{var _=r(p);_!==null&&Vt(x,_.startTime-z)}}function k(z,_){w=!1,S&&(S=!1,d($),$=-1),g=!0;var B=y;try{for(f(_),h=r(u);h!==null&&(!(h.expirationTime>_)||z&&!ze());){var F=h.callback;if(typeof F=="function"){h.callback=null,y=h.priorityLevel;var A=F(h.expirationTime<=_);_=e.unstable_now(),typeof A=="function"?h.callback=A:h===r(u)&&n(u),f(_)}else n(u);h=r(u)}if(h!==null)var Ut=!0;else{var Ve=r(p);Ve!==null&&Vt(x,Ve.startTime-_),Ut=!1}return Ut}finally{h=null,y=B,g=!1}}var E=!1,C=null,$=-1,H=5,T=-1;function ze(){return!(e.unstable_now()-T<H)}function At(){if(C!==null){var z=e.unstable_now();T=z;var _=!0;try{_=C(!0,z)}finally{_?Ht():(E=!1,C=null)}}else E=!1}var Ht;if(typeof c=="function")Ht=function(){c(At)};else if(typeof MessageChannel<"u"){var Jn=new MessageChannel,Il=Jn.port2;Jn.port1.onmessage=At,Ht=function(){Il.postMessage(null)}}else Ht=function(){b(At,0)};function Jr(z){C=z,E||(E=!0,Ht())}function Vt(z,_){$=b(function(){z(e.unstable_now())},_)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(z){z.callback=null},e.unstable_continueExecution=function(){w||g||(w=!0,Jr(k))},e.unstable_forceFrameRate=function(z){0>z||125<z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):H=0<z?Math.floor(1e3/z):5},e.unstable_getCurrentPriorityLevel=function(){return y},e.unstable_getFirstCallbackNode=function(){return r(u)},e.unstable_next=function(z){switch(y){case 1:case 2:case 3:var _=3;break;default:_=y}var B=y;y=_;try{return z()}finally{y=B}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(z,_){switch(z){case 1:case 2:case 3:case 4:case 5:break;default:z=3}var B=y;y=z;try{return _()}finally{y=B}},e.unstable_scheduleCallback=function(z,_,B){var F=e.unstable_now();switch(typeof B=="object"&&B!==null?(B=B.delay,B=typeof B=="number"&&0<B?F+B:F):B=F,z){case 1:var A=-1;break;case 2:A=250;break;case 5:A=1073741823;break;case 4:A=1e4;break;default:A=5e3}return A=B+A,z={id:v++,callback:_,priorityLevel:z,startTime:B,expirationTime:A,sortIndex:-1},B>F?(z.sortIndex=B,t(p,z),r(u)===null&&z===r(p)&&(S?(d($),$=-1):S=!0,Vt(x,B-F))):(z.sortIndex=A,t(u,z),w||g||(w=!0,Jr(k))),z},e.unstable_shouldYield=ze,e.unstable_wrapCallback=function(z){var _=y;return function(){var B=y;y=_;try{return z.apply(this,arguments)}finally{y=B}}}})(jc);Cc.exports=jc;var jp=Cc.exports;/**
 * @license React
...
`,sr=({value:e,onChange:t,onClear:r,placeholder:n="Search...",compact:o=!1,...l})=>a.jsxs(pm,{$compact:o,children:[a.jsx(hm,{$compact:o,children:a.jsx($a,{})}),a.jsx(mm,{type:"text",value:e,onChange:t,placeholder:n,$compact:o,...l}),e&&r&&a.jsx(gm,{onClick:r,type:"button",$compact:o,children:a.jsx(Qr,{})})]}),lt=({icon:e,title:t,description:r,className:n,actionButton:o,transparent:l=!1})=>a.jsxs(ym,{className:n,children:[a.jsxs(vm,{children:[a.jsx(wm,{children:e}),a.jsx(Sm,{children:t}),r&&a.jsx(km,{children:r}),o&&a.jsx(Cm,{children:o})]}),!l&&a.jsx(xm,{})]}),ym=m.div`
  display: flex;
  align-items: center;
  justify-content: center;
  padding: 3rem;
...
`,$s=({variant:e="primary",size:t="medium",icon:r,iconPosition:n="left",fullWidth:o=!1,children:l,...i})=>a.jsxs(zm,{$variant:e,$size:t,$fullWidth:o,$hasIcon:!!r,$iconPosition:n,...i,children:[r&&r,l]}),Pm=m.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
`,Rm=m.div`
  ...
  gap: 1.5rem;
`,Om=({hideHeader:e=!1})=>{const{myBills:t,getLocale:r,selectBill:n}=Ze(),[o,l]=L.useState(""),[i,s]=L.useState(!1),[u,p]=L.useState(null),v=t.filter(g=>{const w=o.toLowerCase();return g.reason.toLowerCase().includes(w)||g.billedBy.name.toLowerCase().includes(w)||g.billedBy.job.toLowerCase().includes(w)||g.amount.toString().includes(w)||g.date.toLowerCase().includes(w)}),h=g=>{const w=t.find(S=>S.id===g);w&&(n(w),p(g),s(!0))},y=()=>{s(!1),p(null)};return a.jsxs(Im,{children:[!e&&a.jsxs(Mm,{children:[a.jsx(Dm,{children:r("myBillsHeading","My Bills")}),a.jsx(sr,{value:o,onChange:g=>l(g.target.value),onClear:()=>l(""),placeholder:r("searchBills","Search bills...")})]}),t.length===0?a.jsx(lt,{icon:a.jsx(Wh,{}),title:r("noBillsAvailable","No Bills Available"),description:r("noBillsAvailableDescription","You currently don't have any bills. Check back later!")}):a.jsx(Rm,{children:v.map(g=>a.jsx(ba,{bill:g,onClick:()=>h(g.id)},g.id))}),i&&u&&a.jsx(Tm,{billId:u,onClose:y})]})},Fm=ve`
  from {
    opacity: 0;
    transform: scale(0.9);
  }
...
`,n2=m.div`
  ...
  color: var(--text-secondary);
  opacity: 0.8;
`,o2=({hideHeader:e=!1})=>{const{billingHistory:t,isLoading:r,getLocale:n}=Ze(),[o,l]=L.useState(""),[i,s]=L.useState(null),[u,p]=L.useState(!1),v=t.filter(g=>{const w=o.toLowerCase();return g.reason.toLowerCase().includes(w)||g.billedBy.name.toLowerCase().includes(w)||g.amount.toString().includes(w)}),h=g=>{s(g)},y=()=>{p(!0),setTimeout(()=>{s(null),p(!1)},300)};return a.jsxs(Hm,{children:[!e&&a.jsx(Vm,{children:a.jsx(Um,{children:n("billHistoryHeading","Payment History")})}),a.jsx(Wm,{children:a.jsx(sr,{value:o,onChange:g=>l(g.target.value),onClear:()=>l(""),placeholder:n("searchBills","Search bill history...")})}),r?a.jsx(nc,{icon:a.jsx(zs,{}),title:n("loading","Loading...")}):v.length===0?a.jsx(nc,{icon:a.jsx(zs,{}),title:n("noBillHistoryFound","No bill history found"),description:n("noBillHistoryFoundDesc","You don't have any bill history yet")}):a.jsx(Qm,{children:v.map(g=>a.jsx(ba,{bill:g,type:"history",onClick:()=>h(g)},g.id))}),i&&a.jsx(Ym,{$isClosing:u,children:a.jsxs(Gm,{children:[a.jsx(Km,{onClick:y,children:a.jsx(Qr,{})}),a.jsxs(Xm,{children:[a.jsx(Jm,{children:n("receiptTitle","Payment Record")}),a.jsxs(Zm,{children:[i.date," • ",i.time]})]}),a.jsxs(hi,{children:[a.jsxs(mi,{children:[n("fromLabel","From"),":"]}),a.jsx(gi,{children:i.billedBy.job})]}),a.jsxs(hi,{children:[a.jsxs(mi,{children:[n("byLabel","By"),":"]}),a.jsx(gi,{children:i.billedBy.name})]}),a.jsx(qm,{}),a.jsxs(hi,{children:[a.jsxs(mi,{children:[n("reason","Reason"),":"]}),a.jsx(gi,{children:i.reason})]}),a.jsxs(e2,{children:[a.jsx(t2,{children:n("totalAmount","TOTAL")}),a.jsxs(r2,{children:[n("currencySymbol","$"),typeof i.amount=="string"?parseFloat(i.amount).toFixed(2):typeof i.amount=="number"?i.amount.toFixed(2):"0.00"]})]}),a.jsx(n2,{children:n("receiptFooter","Thank you for your business")})]})})]})},l2=ve`
  from {
    opacity: 0;
    transform: scale(0.9);
  }
...
`,j2=({hideHeader:e=!1})=>{const t=Ze(),[r,n]=L.useState(""),[o,l]=L.useState(!1),[i,s]=L.useState(null),[u,p]=L.useState(!1),v=(t==null?void 0:t.societyBills)||[],h=(t==null?void 0:t.getLocale)||((S,b)=>b);if(L.useEffect(()=>{l(!1)},[]),!t)return a.jsx(yi,{children:a.jsx(lt,{icon:a.jsx(Do,{}),title:"Error Loading Bills",description:"Unable to load society bills. Please try again later."})});let y=[];try{y=v.filter(S=>{if(!S)return!1;try{const b=r.toLowerCase(),d=S.reason&&typeof S.reason=="string"?S.reason.toLowerCase().includes(b):!1,c=S.billedBy&&S.billedBy.name&&typeof S.billedBy.name=="string"?S.billedBy.name.toLowerCase().includes(b):!1,f=S.amount!==void 0?S.amount.toString().includes(b):!1,x=S.date&&typeof S.date=="string"?S.date.toLowerCase().includes(b):!1;return d||c||f||x}catch(b){return console.error("Error filtering bill:",b),!1}})}catch(S){console.error("Error in SocietyBills component:",S),l(!0)}const g=S=>{s(S)},w=()=>{p(!0),setTimeout(()=>{s(null),p(!1)},300)};return o?a.jsx(yi,{children:a.jsx(lt,{icon:a.jsx(Do,{}),title:"Error Loading Bills",description:"An error occurred while loading society bills. Please try again later."})}):a.jsxs(yi,{children:[!e&&a.jsxs(s2,{children:[a.jsx(a2,{children:h("societyBillsHeading","Organization Finances")}),a.jsx(sr,{value:r,onChange:S=>n(S.target.value),onClear:()=>n(""),placeholder:h("searchSocietyBills","Search society bills...")})]}),e&&a.jsx(u2,{children:a.jsx(sr,{value:r,onChange:S=>n(S.target.value),onClear:()=>n(""),placeholder:h("searchSocietyBills","Search society bills...")})}),!v||v.length===0?a.jsx(k2,{icon:a.jsx(Do,{}),title:h("noSocietyBills","No Society Bills"),description:h("noSocietyBillsDescription","There are currently no society bills available. Check again later!")}):a.jsx(c2,{children:y.map(S=>a.jsx(d2,{children:a.jsx(ba,{bill:S,type:"society",onClick:()=>g(S)})},S.id))}),i&&a.jsx(f2,{$isClosing:u,children:a.jsxs(p2,{children:[a.jsx(C2,{onClick:w,children:a.jsx(Qr,{})}),a.jsxs(h2,{children:[a.jsx(m2,{children:h("receiptTitle","Payment Record")}),a.jsxs(g2,{children:[i.date," • ",i.time]})]}),a.jsxs(vi,{children:[a.jsxs(xi,{children:[h("fromLabel","From"),":"]}),a.jsx(wi,{children:i.billedBy.job})]}),a.jsxs(vi,{children:[a.jsxs(xi,{children:[h("byLabel","By"),":"]}),a.jsx(wi,{children:i.billedBy.name})]}),a.jsx(y2,{}),a.jsxs(vi,{children:[a.jsxs(xi,{children:[h("reason","Reason"),":"]}),a.jsx(wi,{children:i.reason})]}),a.jsxs(v2,{children:[a.jsx(x2,{children:h("totalAmount","TOTAL")}),a.jsxs(w2,{children:[h("currencySymbol","$"),typeof i.amount=="string"?parseFloat(i.amount).toFixed(2):typeof i.amount=="number"?i.amount.toFixed(2):"0.00"]})]}),a.jsx(S2,{children:h("receiptFooter","Thank you for your business")})]})})]})},E2=e=>{switch(e){case"small":return G`
        padding: 0.4rem 0.8rem;
        font-size: 0.8rem;
      `;case"medium":return G`
        padding: 0.6rem 1rem;
...
`,B2=m.p`
  ...
  font-size: 0.8rem;
`,oc=({label:e,error:t,icon:r,iconPosition:n="left",size:o="medium",fullWidth:l=!1,...i})=>a.jsxs(z2,{$fullWidth:l,children:[e&&a.jsx(P2,{children:e}),a.jsxs($2,{children:[r&&a.jsx(_2,{$position:n,children:r}),a.jsx(b2,{$size:o,$hasError:!!t,$hasIcon:!!r,$iconPosition:n,...i})]}),t&&a.jsx(B2,{children:t})]}),L2=m.div`
  display: flex;
  flex-direction: column;
  height: 100%;
  overflow: hidden;
...
`,hg=m.p`
  ...
  color: var(--text-secondary);
  margin-bottom: 0;
`,mg=()=>{const{nearbyPlayers:e,isLoading:t,getLocale:r,billPlayer:n}=Ze(),[o,l]=L.useState(""),[i,s]=L.useState(null),[u,p]=L.useState(""),[v,h]=L.useState(""),[y,g]=L.useState(!1),w=new Date().toLocaleDateString();L.useEffect(()=>{if(y){const x=setTimeout(()=>{g(!1)},3e3);return()=>clearTimeout(x)}},[y]);const S=e.filter(x=>{const k=o.toLowerCase();return x.name.toLowerCase().includes(k)||x.cid.toLowerCase().includes(k)}),b=x=>{s(x)},d=()=>{i&&u&&v&&(n(i.cid,u,parseFloat(v)),g(!0),p(""),h(""),s(null))},c=()=>t?a.jsx(lt,{icon:a.jsx(rg,{}),title:r("loadingNearbyPlayers","Loading nearby players..."),className:"min-h-auto",transparent:!0}):e.length===0?a.jsx(lt,{icon:a.jsx(rc,{}),title:r("noNearbyPlayersFound","No nearby players"),description:r("noPlayersDescription","No players were found nearby. Get closer to players to bill them."),className:"min-h-auto",transparent:!0}):a.jsxs(a.Fragment,{children:[a.jsx(I2,{children:a.jsx(sr,{value:o,onChange:x=>l(x.target.value),onClear:()=>l(""),placeholder:r("searchPlayersPlaceholder","Search players...")})}),a.jsx(M2,{children:S.length===0&&o.length>0?a.jsxs("div",{style:{padding:"2rem",textAlign:"center",color:"var(--text-secondary)"},children:[a.jsx(rc,{style:{fontSize:"2rem",marginBottom:"1rem",opacity:.7}}),a.jsx("h3",{style:{marginBottom:"0.5rem",color:"var(--text-primary)"},children:r("noMatchingPlayersFound","No matching players")}),a.jsx("p",{children:r("noMatchingPlayersDescription","No players match your search criteria. Try a different search term.")})]}):S.map(x=>a.jsxs(D2,{$isSelected:(i==null?void 0:i.cid)===x.cid,onClick:()=>b(x),children:[a.jsx(R2,{children:a.jsx(jn,{})}),a.jsxs(O2,{children:[a.jsx(F2,{$isSelected:(i==null?void 0:i.cid)===x.cid,children:x.name}),a.jsxs(A2,{$isSelected:(i==null?void 0:i.cid)===x.cid,children:["#",x.cid]})]})]},x.cid))})]}),f=()=>{if(!i)return a.jsx(lt,{icon:a.jsx(tc,{}),title:r("noBillingForm","Select a player"),description:r("selectPlayerPrompt","Select a player from the left panel to create a bill."),className:"min-h-auto billing-empty-state",transparent:!0});const x=v?parseFloat(v).toFixed(2):"0.00";return a.jsx(V2,{children:a.jsxs(U2,{children:[a.jsxs(ng,{children:[a.jsx(og,{children:a.jsx(jn,{})}),a.jsxs(lg,{children:[a.jsx(ig,{children:i.name}),a.jsxs(sg,{children:["#",i.cid]})]})]}),a.jsxs(sc,{children:[a.jsx(ac,{children:r("reasonForBill","Reason for Bill")}),a.jsx(oc,{type:"text",value:u,onChange:k=>p(k.target.value),placeholder:r("enterReasonPlaceholder","Enter reason for the bill...")})]}),a.jsxs(sc,{children:[a.jsx(ac,{children:r("amountLabel","Amount")}),a.jsxs(q2,{children:[a.jsx(eg,{children:r("currencySymbol","$")}),a.jsx(oc,{type:"text",value:v,onChange:k=>{const E=/^[0-9]*\.?[0-9]*$/;(k.target.value===""||E.test(k.target.value))&&h(k.target.value)},placeholder:r("enterAmountPlaceholder","0.00"),style:{paddingLeft:"2rem"}})]})]}),a.jsx(tg,{children:a.jsx($s,{onClick:d,disabled:!u||!v,icon:a.jsx(Yh,{}),variant:"primary",children:r("sendBill","Send Bill")})}),a.jsxs(W2,{children:[a.jsxs(Q2,{children:[a.jsxs(Y2,{children:[a.jsx(ep,{}),r("receiptTitle","Receipt")]}),a.jsx(G2,{children:w})]}),a.jsxs(K2,{children:[a.jsxs(Si,{children:[a.jsx(ki,{children:r("recipient","Recipient:")}),a.jsx(Ci,{children:i.name})]}),a.jsxs(Si,{children:[a.jsx(ki,{children:r("citizenId","Citizen ID:")}),a.jsxs(Ci,{children:["#",i.cid]})]}),a.jsxs(Si,{children:[a.jsx(ki,{children:r("reason","Reason:")}),a.jsx(Ci,{children:u||"-"})]})]}),a.jsxs(X2,{children:[a.jsx(J2,{children:r("totalDue","Total Due:")}),a.jsxs(Z2,{children:[r("currencySymbol","$"),x]})]})]})]})})};return a.jsx(L2,{children:a.jsxs(N2,{children:[a.jsxs(T2,{children:[a.jsx(lc,{children:a.jsxs(ic,{children:[a.jsx(jn,{}),r("selectRecipient","Select Recipient")]})}),c()]}),a.jsxs(H2,{children:[a.jsx(lc,{children:a.jsxs(ic,{children:[a.jsx(tc,{}),r("createBill","Create Bill")]})}),f(),y&&a.jsx(cg,{children:a.jsxs(dg,{children:[a.jsx(fg,{}),a.jsx(pg,{children:r("billSentSuccessTitle","Bill Sent Successfully")}),a.jsx(hg,{children:r("billSentSuccessDescription","The bill has been sent to the player successfully.")})]})})]})]})})},gg=e=>{switch(e){case"default":return G`
        background-color: var(--card-bg);
        border: none;
        box-shadow: var(--shadow-sm);
...
`,vg=m.h3`
  ...
  margin-bottom: 1rem;
  color: var(--text-primary);
`,xg=({variant:e="default",title:t,children:r,className:n,onClick:o,hoverable:l=!1,padding:i="1rem",...s})=>a.jsxs(yg,{$variant:e,$hoverable:l,$padding:i,$isClickable:!!o,className:n,onClick:o,...s,children:[t&&a.jsx(vg,{children:t}),r]}),wg=m.div`
  display: flex;
  flex-direction: column;
  position: relative;
`,Sg=m.div`
...
`,Bg=[{id:"p1",name:"John Doe",cid:"CID123456"},{id:"p2",name:"Jane Smith",cid:"CID789012"},{id:"p3",name:"Michael Johnson",cid:"CID345678"},{id:"p4",name:"Sarah Williams",cid:"CID901234"},{id:"p5",name:"David Brown",cid:"CID567890"}],Lg=()=>{const[e,t]=L.useState(""),[r,n]=L.useState(!1),[o,l]=L.useState(!1),[i,s]=L.useState(!1),{players:u=[],fetchOnlinePlayers:p,fetchPlayerBills:v,getLocale:h}=Ze();L.useEffect(()=>(e.length>=2&&u&&u.length>0&&n(!1),()=>{n(!1),l(!1)}),[u,e]);const y=()=>{if(!e||e.length<2)return[];const d=i||!Array.isArray(u)||u.length===0?Bg:u,c=e.toLowerCase().trim();return d.filter(f=>{if(!f)return!1;const x=((f.name||"")+"").toLowerCase(),k=((f.cid||f.id||"")+"").toLowerCase();return x.indexOf(c)!==-1||k.indexOf(c)!==-1})},g=d=>{const c=d.target.value||"";if(t(c),c.length<2){n(!1);return}if(c.length>=2){n(!0),l(!1);try{p(c),setTimeout(()=>{n(!1),(!u||u.length===0)&&(i||(console.log("No results, switching to mock mode"),s(!0)))},1e3)}catch(f){console.error("Error fetching players:",f),l(!0),n(!1),s(!0)}}},w=()=>{t(""),n(!1),l(!1),s(!1)},S=(d,c)=>{if(d)try{console.log("Player clicked:",c.name,"CID:",d),setTimeout(()=>{v(d)},100)}catch(f){console.error("Error handling player click:",f),l(!0),n(!1)}},b=y();return a.jsxs(wg,{children:[a.jsx(Sg,{children:a.jsx(sr,{value:e,onChange:g,onClear:w,placeholder:h("searchByNameOrCid","Search by name or CID...")})}),o&&a.jsxs(_g,{children:[a.jsx(Qh,{}),a.jsx("span",{children:h("networkError","Network error. Showing limited results instead.")})]}),r?a.jsxs($g,{children:[a.jsx(bg,{}),a.jsx("p",{children:h("loadingPlayers","Loading players...")})]}):e.length<2?a.jsx(uc,{icon:a.jsx($a,{}),title:h("searchToInspect","Search to Inspect Citizens"),description:h("startSearchingDesc","Enter a name or CID to search for citizens to inspect their bills.")}):b.length===0?a.jsx(uc,{icon:a.jsx(Hh,{}),title:h("noResultsFound","No Results Found"),description:h("trySearchingDifferentName","Try searching for a different name or CID.")}):a.jsx(kg,{children:b.map(d=>a.jsxs(Un,{onClick:()=>S(d.cid||d.id||"",d),hoverable:!0,children:[a.jsx(Cg,{children:a.jsx(Jh,{})}),a.jsxs(jg,{children:[a.jsx(Eg,{children:d.name||"Unknown"}),a.jsxs(zg,{children:["CID: ",d.cid||d.id||"Unknown"]})]}),a.jsx(Pg,{children:a.jsx(Mh,{})})]},d.cid||d.id||Math.random().toString()))})]})},Ng=m.div`
  display: flex;
  width: 100%;
  height: 100%;
  background-color: var(--background-color);
...
`,Ag=()=>{const[e,t]=L.useState("myBills"),{fetchNearbyPlayers:r,fetchOnlinePlayers:n,closeUI:o,developmentMode:l}=Ze(),[i,s]=L.useState(!0);ke.useEffect(()=>{setTimeout(()=>{s(!1)},5e3)},[]);const u=v=>{t(v),v==="billPlayer"?r():v==="inspectCitizen"&&n("")},p=()=>{switch(e){case"myBills":return"My Bills";case"billingHistory":return"Bill History";case"societyBills":return"Society Bills";case"billPlayer":return"Bill Player";case"inspectCitizen":return"Inspect Citizen";default:return"Bills"}};return a.jsxs(Ng,{children:[a.jsx(nm,{currentView:e,setView:u}),a.jsxs(Tg,{children:[a.jsxs(Ig,{children:[a.jsx(Mg,{children:p()}),a.jsx(Dg,{children:a.jsx(Rg,{onClick:o,title:"Close",children:a.jsx(Kh,{})})})]}),a.jsxs(Og,{children:[l&&i&&a.jsxs(Fg,{children:[a.jsx(Ah,{}),a.jsx("span",{children:"Using dummy data for demonstration"})]}),e==="myBills"&&a.jsx(Om,{hideHeader:!0}),e==="billingHistory"&&a.jsx(o2,{hideHeader:!0}),e==="societyBills"&&a.jsx(j2,{hideHeader:!0}),e==="billPlayer"&&a.jsx(mg,{hideHeader:!0}),e==="inspectCitizen"&&a.jsx(Lg,{})]})]})]})},Hg=ve`
  from { opacity: 0; }
  to { opacity: 1; }
`,Vg=ve`
  from { opacity: 1; }
...
`,Yg=m.div`
  ...
  &.closing {
    animation: ${Wg} 0.3s ease-out forwards;
  }
`,Gg=m.header`
  padding: 1.25rem 1.5rem;
  border-bottom: 1px solid var(--border-color);
...
`,ly=()=>{const{selectedPlayer:e,selectedPlayerBills:t,showSelectedPlayerMenu:r,getLocale:n,closePlayerBills:o}=Ze(),[l,i]=L.useState(""),[s,u]=L.useState(!1),[p,v]=L.useState([]);L.useEffect(()=>{r||(i(""),u(!1),v([]))},[r]),L.useEffect(()=>{t&&v(t)},[t]);const h=L.useCallback(()=>{try{u(!0),setTimeout(()=>{o()},300)}catch(g){console.error("Error closing player bills:",g)}},[o]);if(L.useEffect(()=>{const g=w=>{w.key==="Escape"&&r&&h()};return window.addEventListener("keydown",g),()=>window.removeEventListener("keydown",g)},[r,h]),!r||!e)return null;const y=p.filter(g=>{const w=l.toLowerCase();return g.reason.toLowerCase().includes(w)||g.amount.toString().includes(w)||g.date.toLowerCase().includes(w)||g.billedBy.name.toLowerCase().includes(w)});return a.jsx(Qg,{onClick:h,className:s?"closing":"",children:a.jsxs(Yg,{onClick:g=>g.stopPropagation(),className:s?"closing":"",children:[a.jsxs(Gg,{children:[a.jsxs(Kg,{children:[a.jsx(ep,{}),n("playerBillsTitle","Player Bills")]}),a.jsx(oy,{onClick:h,"aria-label":"Close",children:a.jsx(Qr,{})})]}),a.jsx(Xg,{children:a.jsx(sr,{value:l,onChange:g=>i(g.target.value),onClear:()=>i(""),placeholder:n("searchBillsPlaceholder","Search bills...")})}),a.jsx(Jg,{children:y.length===0?a.jsx(Zg,{children:a.jsx(lt,{icon:a.jsx(Ps,{}),title:n("noBillsFound","No bills found"),description:n("noBillsDescription","No bills match your search criteria."),transparent:!0})}):y.map((g,w)=>a.jsxs(qg,{children:[a.jsxs(ey,{children:[a.jsxs(ty,{children:[n("currencySymbol","$"),typeof g.amount=="number"?g.amount.toFixed(2):parseFloat(String(g.amount||0)).toFixed(2)]}),a.jsxs(ry,{$isPaid:g.paid,children:[a.jsx("span",{className:"status-indicator"}),g.paid?n("paidStatus","Paid"):n("unpaidStatus","Unpaid")]})]}),a.jsxs(ny,{children:[a.jsxs(xo,{children:[a.jsx(Ps,{}),a.jsxs("div",{children:[a.jsx("strong",{children:n("reasonLabel","Reason:")}),a.jsx("span",{children:g.reason})]})]}),a.jsxs(xo,{children:[a.jsx(jn,{}),a.jsxs("div",{children:[a.jsx("strong",{children:n("billedByLabel","Billed By:")}),a.jsx("span",{children:g.billedBy.name})]})]}),a.jsxs(xo,{children:[a.jsx(Xh,{}),a.jsxs("div",{children:[a.jsx("strong",{children:n("fromLabel","From:")}),a.jsx("span",{children:g.billedBy.job})]})]}),a.jsxs(xo,{children:[a.jsx(Oh,{}),a.jsxs("div",{children:[a.jsx("strong",{children:n("dateLabel","Date:")}),a.jsx("span",{children:g.date})]})]})]})]},g.id||w))})]})})},iy=()=>a.jsx(b1,{children:a.jsx(sy,{})}),sy=()=>{const{showMenu:e,isClosing:t}=Ze();return L.useEffect(()=>{const r=n=>{n.key};return window.addEventListener("keydown",r),()=>window.removeEventListener("keydown",r)},[e]),!e&&!t?null:a.jsxs(a.Fragment,{children:[a.jsxs(fy,{$visible:e,$isClosing:t,children:[a.jsx(py,{}),a.jsxs(hy,{$isClosing:t,children:[a.jsx(my,{}),a.jsx(Ag,{}),a.jsx(cc,{position:"top-left"}),a.jsx(cc,{position:"bottom-right"})]})]}),a.jsx(ly,{})]})},ay=ve`
  from { opacity: 0; }
  to { opacity: 1; }
`,uy=ve`
  from { opacity: 1; }
...
`,fy=m.div`
  ...
  justify-content: center;
  z-index: 1000;
  animation: ${({$isClosing:e})=>e?uy:ay} 0.3s ease forwards;
  user-select: none;
...
`,hy=m.div`
  ...
  animation: ${({$isClosing:e})=>e?dy:cy} 0.3s ease forwards;
...
`,cc=m.div`
  ...
  &::before, &::after {
    ...
    opacity: 0.3;
    animation: ${gy} 4s infinite ease-in-out;
  }
...
`;ji.createRoot(document.getElementById("app")).render(a.jsx(ke.StrictMode,{children:a.jsx(iy,{})}));
