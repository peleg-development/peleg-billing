...
`,iv=m.h3`
  ...
  margin-bottom: 1rem;
  color: var(--text-primary);
`,lv=({variant:e="default",title:t,children:r,className:n,onClick:o,hoverable:i=!1,padding:l="1rem",...s})=>a.jsxs(ov,{$variant:e,$hoverable:i,$padding:l,$isClickable:!!o,className:n,onClick:o,...s,children:[t&&a.jsx(iv,{children:t}),r]}),av=m.div`
  display: flex;
  flex-direction: column;
  position: relative;
`,sv=m.div`
...
`,yv=()=>{const[e,t]=T.useState(""),[r,n]=T.useState(!1),[o,i]=T.useState(!1),{players:l=[],fetchOnlinePlayers:s,fetchPlayerBills:c,getLocale:p}=Te();T.useEffect(()=>(e.length>=2&&l&&l.length>0&&n(!1),()=>{n(!1),i(!1)}),[l,e]);const y=()=>{if(!e||e.length<2)return[];const j=e.toLowerCase().trim();return l.filter(C=>{if(!C)return!1;const h=((C.name||"")+"").toLowerCase(),d=((C.cid||C.id||"")+"").toLowerCase();return h.indexOf(j)!==-1||d.indexOf(j)!==-1})},w=j=>{const C=j.target.value||"";if(t(C),C.length<2){n(!1);return}if(C.length>=2){n(!0),i(!1);try{s(C),setTimeout(()=>{n(!1)},1e3)}catch(h){console.error("Error fetching players:",h),i(!0),n(!1)}}},f=()=>{t(""),n(!1),i(!1)},x=j=>{if(j)try{setTimeout(()=>{c(j)},100)}catch(C){console.error("Error handling player click:",C),i(!0),n(!1)}},k=y();return a.jsxs(av,{children:[a.jsx(sv,{children:a.jsx(tn,{value:e,onChange:w,onClear:f,placeholder:p("searchByNameOrCid","Search by name or CID...")})}),o&&a.jsxs(vv,{children:[a.jsx(Lm,{}),a.jsx("span",{children:p("networkError","Network error. Showing limited results instead.")})]}),r?a.jsxs(mv,{children:[a.jsx(gv,{}),a.jsx("p",{children:p("loadingPlayers","Loading players...")})]}):e.length<2?a.jsx(Tu,{icon:a.jsx(tl,{}),title:p("searchToInspect","Search to Inspect Citizens"),description:p("startSearchingDesc","Enter a name or CID to search for citizens to inspect their bills.")}):k.length===0?a.jsx(Tu,{icon:a.jsx($m,{}),title:p("noResultsFound","No Results Found"),description:p("trySearchingDifferentName","Try searching for a different name or CID.")}):a.jsx(cv,{children:k.map(j=>a.jsxs(Zn,{onClick:()=>x(j.cid||j.id||""),hoverable:!0,children:[a.jsx(uv,{children:a.jsx(Hm,{})}),a.jsxs(dv,{children:[a.jsx(fv,{children:j.name||"Unknown"}),a.jsxs(pv,{children:["CID: ",(j.cid||j.id||"Unknown").slice(0,10)]})]}),a.jsx(hv,{children:a.jsx(xm,{})})]},j.cid||j.id||Math.random().toString()))})]})},xv=m.div`
  display: flex;
  flex-direction: column;
  gap: 1rem;
  height: 100%;
...
`,Fv=()=>{const[e,t]=T.useState("myBills"),{fetchNearbyPlayers:r,fetchOnlinePlayers:n,closeUI:o,developmentMode:i}=Te(),[l,s]=T.useState(!0);ke.useEffect(()=>{setTimeout(()=>{s(!1)},5e3)},[]),ke.useEffect(()=>{console.log("Dashboard current view:",e)},[e]);const c=y=>{console.log("Changing view to:",y),t(y),y==="billPlayer"?r():y==="inspectCitizen"&&n("")},p=()=>{switch(e){case"myBills":return"My Bills";case"billingHistory":return"Bill History";case"billingStats":return"Billing Statistics";case"societyBills":return"Society Bills";case"billPlayer":return"Bill Player";case"inspectCitizen":return"Inspect Citizen";default:return"Bills"}};return a.jsxs(Nv,{children:[a.jsx(Gm,{currentView:e,setView:c}),a.jsxs(Tv,{children:[a.jsxs(_v,{children:[a.jsx(Mv,{children:p()}),a.jsx(Rv,{children:a.jsx(Iv,{onClick:o,title:"Close",children:a.jsx(Mm,{})})})]}),a.jsxs(Dv,{children:[i&&l&&a.jsxs(Ov,{children:[a.jsx(Cm,{}),a.jsx("span",{children:"Using dummy data for demonstration"})]}),a.jsxs("div",{style:{height:"100%",width:"100%",position:"relative"},children:[e==="myBills"&&a.jsx(L2,{hideHeader:!0}),e==="billingHistory"&&a.jsx(og,{hideHeader:!0}),e==="billingStats"&&a.jsx(Lv,{hideHeader:!0}),e==="societyBills"&&a.jsx(dg,{hideHeader:!0}),e==="billPlayer"&&a.jsx(rv,{hideHeader:!0}),e==="inspectCitizen"&&a.jsx(yv,{})]})]})]})]})},Av=it`
  from { opacity: 0; }
  to { opacity: 1; }
`,Hv=it`
  from { opacity: 1; }
...
`,P4=m.div`
  ...
  color: #ef4444;
  font-size: 14px;
`,E4=()=>a.jsx(fh,{children:a.jsx(B4,{})}),B4=()=>{const{showMenu:e,showQuickBill:t,isClosing:r}=Te();return T.useEffect(()=>{const n=o=>{o.key};return window.addEventListener("keydown",n),()=>window.removeEventListener("keydown",n)},[e,t]),!e&&!t&&!r?null:a.jsxs(a.Fragment,{children:[e&&a.jsxs(M4,{$visible:e,$isClosing:r,children:[a.jsx(R4,{}),a.jsxs(I4,{$isClosing:r,children:[a.jsx(D4,{}),a.jsx(Fv,{}),a.jsx(Yu,{position:"top-left"}),a.jsx(Yu,{position:"bottom-right"})]})]}),a.jsx(p4,{}),a.jsx(h4,{})]})},L4=it`
  from { opacity: 0; }
  to { opacity: 1; }
`,N4=it`
  from { opacity: 1; }
...
`,M4=m.div`
  ...
  justify-content: center;
  z-index: 1000;
  animation: ${({$isClosing:e})=>e?N4:L4} 0.3s ease forwards;
  user-select: none;
...
`,I4=m.div`
  ...
  animation: ${({$isClosing:e})=>e?_4:T4} 0.3s ease forwards;
...
`,Yu=m.div`
  ...
  &::before, &::after {
    ...
    opacity: 0.3;
    animation: ${O4} 4s infinite ease-in-out;
  }
...
`;Yl.createRoot(document.getElementById("app")).render(a.jsx(ke.StrictMode,{children:a.jsx(E4,{})}));
